...
class SentimentGrade extends Component {
  render() {
    return (
      <div>
        <svg width="100%" height={60}>
          ...
          <text x="0" y="16" fontSize="16" fill="#000">Sentiment Analysis' Summary</text>
          ...
          <text x="0" y="58" fontSize="10" fill="grey">Strong Sell</text>
          <text x="25%" y="58" fontSize="10" fill="grey">Sell</text>
          <text x="75%" y="58" fontSize="10" fill="grey">Buy</text>
          <text x="100%" y="58" fontSize="10" fill="grey" textAnchor="end">Strong Buy</text>
        </svg>
      </div>
    );
  }
...
export default immutableToJsComponent(SentimentGrade);
